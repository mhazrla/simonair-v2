        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="grid gap-6">
                ...
                <div class="text-center">
                    ...
                    <label class="text-sm text-gray-500 ">Other
                        Method</label>
                    <hr>
                    <a type="button" href="/auth/google/redirect"
                        class=" justify-center w-full gap-2 text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
