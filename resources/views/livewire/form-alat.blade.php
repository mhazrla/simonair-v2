<div>
    <x-button data-modal-target="tambah-alat-modal" data-modal-toggle="tambah-alat-modal" target="_blank" variant="info"
        class="justify-center max-w-xs gap-2">
        <svg fill="#ffffff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" width="14px" height="14px" viewBox="0 0 349.03 349.031"
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form wire:submit="createAlat" class="space-y-6">
                        @csrf
                        <div>
                            <label for="nama_alat"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                                Alat</label>
                            <input wire:model="nama_alat" type="nama_alat" name="nama_alat" id="nama_alat"
